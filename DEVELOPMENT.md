...
```bash
git remote add encore encore://functional-homepage-sep2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/functional-homepage-sep2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/functional-homepage-sep2/settings/integrations/github)
