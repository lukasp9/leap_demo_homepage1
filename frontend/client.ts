 ...
 */
import { getCategories as api_financial_get_categories_getCategories } from "~backend/financial/get_categories";
import { getProducts as api_financial_get_products_getProducts } from "~backend/financial/get_products";
import { submitInquiry as api_financial_submit_inquiry_submitInquiry } from "~backend/financial/submit_inquiry";
...
export namespace financial {
    ...
    export class ServiceClient {
         ...
         */
        public async getCategories(): Promise<ResponseType<typeof api_financial_get_categories_getCategories>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/categories`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_financial_get_categories_getCategories>
        }

        /**
         * Retrieves financial products by category and subcategory.
         */
        public async getProducts(params: RequestType<typeof api_financial_get_products_getProducts>): Promise<ResponseType<typeof api_financial_get_products_getProducts>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_financial_get_products_getProducts>
        }

        /**
         * Submits a customer inquiry for financial products.
         */
        public async submitInquiry(params: RequestType<typeof api_financial_submit_inquiry_submitInquiry>): Promise<ResponseType<typeof api_financial_submit_inquiry_submitInquiry>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/inquiry`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_financial_submit_inquiry_submitInquiry>
        }
    }
}
